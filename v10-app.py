...
# --- CSS VISUAL (SOLUÇÃO DE ALINHAMENTO E LIMPEZA) ---
st.markdown("""
<style>
    ...
    /* Remove texto extra do uploader */
...
# ==========================================
# vertical_alignment="center" alinha tudo pelo meio verticalmente
...
with c3:
    # Usando Emoji padrão 👤 para garantir que funcione dentro do HTML
