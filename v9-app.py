...
# --- CSS VISUAL (SOLUÇÃO DE ALINHAMENTO) ---
st.markdown("""
<style>
    /* Remove cabeçalho e ajusta margens da página */
    ...
    /* CORREÇÃO DO UPLOAD: Remove margens para alinhar com o texto */
    [data-testid="stFileUploader"] {
        padding-top: 0px !important;
        margin-top: 0px !important;
    }
    
    /* Remove o espaço do label vazio */
    ...
    h5 { 
        ...
        color: #333; 
        line-height: 1.5 !important; /* Ajuda no alinhamento vertical */
    }
    
    /* Remove padding excessivo das colunas */
    [data-testid="column"] { 
    ...
    button[kind="secondary"] {
        ...
        height: 36px !important; /* Altura fixa para alinhar com inputs */
    }
</style>
...
# ==========================================
# MUDANÇA: vertical_alignment="center" resolve o desalinhamento
...
with c2:
    # O CSS vai matar a margem superior deste componente
    uploaded_file = st.file_uploader("Upload", type="pdf", label_visibility="collapsed")

with c3:
    # Alinhamento à direita usando markdown simples para não quebrar o ícone
    st.markdown(f"<div style='text-align:right; vertical-align:middle'>:material/person: <b>{usuario_atual}</b></div>", unsafe_allow_html=True)
